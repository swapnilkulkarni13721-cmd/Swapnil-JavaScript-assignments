...
{
    console.log(`Test ${count + 1} : ${tests[count].testName}`);
    console.log(` Result : ${tests[count].result} `);
    console.log(` Duration: ${tests[count].duration}s`);
    console.log("");
}

let totalTests1 = tests.length;
let totalDuration1 = 0;

for (let test of tests) {
  totalDuration1 = totalDuration1 + test.duration;
}

console.log("════════════════════════════════════════");
console.log(" SUMMARY");
console.log("════════════════════════════════════════");
console.log("Total tests: ", totalTests1);
console.log("Total Duration : ", totalDuration1 + "s");
console.log("════════════════════════════════════════");
